...
<body>
  <section class="navbar1">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand" href="index.php"><img src="./img/dollar image.jpg" class="logo"></a>
  ...
  <section class="sliding px-0 w-100">
    <div class="container-fluid">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-interval="1000" data-ride="carousel">
        ...
        <div class="carousel-inner first1" style="height:500px; width: 100%;">

          <div class="carousel-item active ">
            <img class=" d-block w-100 img-fluid" src="./img/c1 (2).jpg" alt="First slide">
          ...
          <div class="carousel-item">
            <img class=" d-block  w-100 img-fluid " src="./img/c3.jpg" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h1>Make Safe Payment</h1>
              <p>EASY TRANSACTIONS</p>
            </div>
  ...
  <section class="category bg-warning" id="cat">
    <main role="main">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body bg-secondary">
                  <p class="card-text" style="text-align: center; ">View all Customers</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="allcust.php" class="btn btn-primary">View</a>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body bg-secondary">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="transact.html" class="btn btn-primary my-2 my-sm-0 text-light">View
                      </a>
                    </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body bg-secondary">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                      <a href="history.php" class="btn btn-primary my-2 my-sm-0 text-light">View
                      </a>
                    </div>
...
.bc{
        height: 20rem;
        background-image: url("./img/stock image.jpg");
    ...
    <div class="container pt-5 pb-5">
      <div class="row inner-text">
        <div class="col-md-6 text-dangers">
          <h3 class="wow slideInUp"> TRANSACTIONS</h3>
          <h1 class="wow mt-4 slideInDown text-primary">24 *7 HOURS AVAILABLE</h1>
          <a href="./aboutus.html" class="btn btn-primary my-2 my-sm-0">About Us
          </a>
    ...
    <footer class="pt-4 md-5  border-top">
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small text-light">
            <li><a class="text-muted" href="#">nehabaviskar111@gmail.com</a></li>
            <li><a class="text-muted" href="#">123456789</a></li>
